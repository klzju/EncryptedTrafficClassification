...
class ColoredFormatter(logging.Formatter):
    """自定义日志格式化器，支持不同日志等级显示不同颜色"""

    def __init__(self, fmt, datefmt=None):
        super().__init__(fmt, datefmt)
        self.FORMATS = {
            logging.DEBUG: LogColors.DEBUG + fmt + LogColors.RESET,
            logging.INFO: LogColors.INFO + fmt + LogColors.RESET,
            logging.WARNING: LogColors.WARNING + fmt + LogColors.RESET,
            logging.ERROR: LogColors.ERROR + fmt + LogColors.RESET,
            logging.CRITICAL: LogColors.CRITICAL + fmt + LogColors.RESET,
        }
